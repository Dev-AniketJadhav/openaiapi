                ...
                if (binding.direction === 'out') {
                    if (name === constants_1.returnBindingKey) {
                        ...
                        response.outputData.push({
                            name,
                            data: yield __classPrivateFieldGet(this, _InvocationModel_instances, "m", _InvocationModel_convertOutput).call(this, binding, context.extraOutputs.get(name)),
                        });
                    }
                }
            }
...
function http(name, options) {
    ...
    generic(name, Object.assign({ trigger: trigger.http({
...
function timer(name, options) {
    generic(name, Object.assign({ trigger: trigger.timer({
...
function storageBlob(name, options) {
    generic(name, Object.assign({ trigger: trigger.storageBlob({
...
function storageQueue(name, options) {
    generic(name, Object.assign({ trigger: trigger.storageQueue({
            connection: options.connection,
...
function serviceBusQueue(name, options) {
    generic(name, Object.assign({ trigger: trigger.serviceBusQueue({
            connection: options.connection,
            queueName: options.queueName,
...
function serviceBusTopic(name, options) {
    generic(name, Object.assign({ trigger: trigger.serviceBusTopic({
            connection: options.connection,
...
function eventHub(name, options) {
    generic(name, Object.assign({ trigger: trigger.eventHub({
            connection: options.connection,
...
function eventGrid(name, options) {
    generic(name, Object.assign({ trigger: trigger.eventGrid({}) }, options));
}
exports.eventGrid = eventGrid;
function cosmosDB(name, options) {
    generic(name, Object.assign({ trigger: trigger.cosmosDB({
...
function generic(name, options) {
    ...
    if (!coreApi) {
        ...
        coreApi.registerFunction({ name, bindings }, options.handler);
    }
}
...
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generic = exports.cosmosDB = exports.storageBlob = void 0;
...
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generic = exports.cosmosDB = exports.eventGrid = exports.eventHub = exports.serviceBusTopic = exports.serviceBusQueue = exports.storageQueue = exports.storageBlob = exports.http = void 0;
const addBindingName_1 = __webpack_require__(/*! ./addBindingName */ "./src/addBindingName.ts");
