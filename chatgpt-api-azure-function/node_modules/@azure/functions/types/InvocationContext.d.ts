...
import { CosmosDBInput, CosmosDBOutput } from '@azure/functions/types/cosmosDB';
import { EventGridOutput, EventGridPartialEvent } from '@azure/functions/types/eventGrid';
import { EventHubOutput } from '@azure/functions/types/eventHub';
import { HttpOutput, HttpResponse } from '@azure/functions/types/http';
import { FunctionInput, FunctionOutput, FunctionTrigger } from '@azure/functions';
import { ServiceBusQueueOutput, ServiceBusTopicOutput } from '@azure/functions/types/serviceBus';
import { StorageBlobInput, StorageBlobOutput, StorageQueueOutput } from '@azure/functions/types/storage';
