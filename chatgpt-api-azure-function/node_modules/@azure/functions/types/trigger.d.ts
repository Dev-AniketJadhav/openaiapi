...
import { CosmosDBTrigger, CosmosDBTriggerOptions } from '@azure/functions/types/cosmosDB';
import { EventGridTrigger, EventGridTriggerOptions } from '@azure/functions/types/eventGrid';
import { EventHubTrigger, EventHubTriggerOptions } from '@azure/functions/types/eventHub';
import { GenericTriggerOptions } from '@azure/functions/types/generic';
import { HttpTrigger, HttpTriggerOptions } from '@azure/functions/types/http';
import { FunctionTrigger } from '@azure/functions';
import {
    ServiceBusQueueTrigger,
    ServiceBusQueueTriggerOptions,
    ServiceBusTopicTrigger,
    ServiceBusTopicTriggerOptions,
} from '@azure/functions/types/serviceBus';
import {
    StorageBlobTrigger,
    StorageBlobTriggerOptions,
    StorageQueueTrigger,
    StorageQueueTriggerOptions,
} from '@azure/functions/types/storage';
import { TimerTrigger, TimerTriggerOptions } from '@azure/functions/types/timer';
