...
export * as app from '@azure/functions/types/app';
export * from '@azure/functions/types/cosmosDB';
export * from '@azure/functions/types/eventGrid';
export * from '@azure/functions/types/eventHub';
export * from '@azure/functions/types/generic';
export * from '@azure/functions/types/http';
export * as input from '@azure/functions/types/input';
export * from '@azure/functions/types/InvocationContext';
export * as output from '@azure/functions/types/output';
export * from '@azure/functions/types/serviceBus';
export * from '@azure/functions/types/storage';
export * from '@azure/functions/types/timer';
export * as trigger from '@azure/functions/types/trigger';
